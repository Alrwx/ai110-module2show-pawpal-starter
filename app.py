"""pawpal+ streamlit app that hooks the ui up to the scheduler backend."""
...
# --- session state ---
# keep data around between reruns
...
if owner.pets and scheduler.get_all_tasks():
    ...
    if pending:
        ...
        if st.button("Mark complete"):
            # parse selected text into pet name + task description
